...
If you’d like a quick overview of the IDE features please visit the Electric Imp [Dev Center](https://developer.electricimp.com/gettingstarted/explorer/ide).
...
1. Copy and Paste the [agent code](./IoTHubEnvExample_AutoRegister.agent.nut) from GitHub into the IDE’s agent pane (the left-hand side).
