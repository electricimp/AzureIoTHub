...
In additon to the example code at the bottom of this page there are also two detailed step-by-step recipes for connecting an Electric Imp-powered sensor node to Azure IoT Hub, complete with screenshots and diagrams. See the [Examples folder](./examples). 
